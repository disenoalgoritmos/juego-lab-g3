            ...
            if(msg_type=="ADD_USER"):
                ...
                #Caso de exito
                    ...
                    if(len(self.games.get(id_game_user))==1):
                        ...
                        subprocess.Popen(["python",".\servidorGAME_socket.py",addrJugador1[0],str(addrJugador1[1]),addrJugador2[0],str(addrJugador2[1]),addrServer[0],addrServer[1]],creationflags =subprocess.CREATE_NEW_CONSOLE)#Para pruebas con clienteTest 
...
async def main():
    ...
    async with server_asyncio:
        async with server_game_asyncio:
            subprocess.Popen("python .\cliente_test.py",creationflags =subprocess.CREATE_NEW_CONSOLE)#Para pruebas con clienteTest 
